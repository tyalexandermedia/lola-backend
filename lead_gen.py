...
async def finalize_dashboard(
    ...
    out["dashboard"] = f"https://www.coachtyleads.com/r/client/{slug}"
    return out
...
async def inject_test_call(
    ...
    Steps to test the full pipeline:
      ...
      2. Open https://www.coachtyleads.com/r/client/sandbar
    ...
    return {
        ...
        "event_id": eid,
        "ga4": ga4_res,
        "dashboard": f"https://www.coachtyleads.com/r/client/sandbar",
    }
