...
const MOCK_AUDIT = {
  audit_id: 'demo', business_name: 'Sandbar Soft Wash', website: 'https://sandbarsoftwash.com',
  city: 'Palm Harbor, FL', business_type: 'soft wash', email: 'team@sandbarsoftwash.com',
  total_score: 68, grade: 'C', grade_label: 'Needs Work', percentile: 52, segment: 'education',
  lola_message: "Sandbar Soft Wash has solid bones. A few targeted moves turn this into a lead machine.",
  ...
  business_info: { ok: true, name: 'Sandbar Soft Wash', address: '1234 Main St, Palm Harbor, FL',
  ...
  categories: { gbp_completeness: { score: 65 }, reviews: { score: 53 }, mobile_speed: { score: 64 },
                seo_basics: { score: 82 }, accessibility: { score: 78 }, local_trust: { score: 100 }, safety: { score: 100 } },
...
async function shoot(width, height, suffix) {
  ...
  await browser.close();
  console.log(`  ${suffix}: ${width}×${height} → /tmp/pricing-${suffix}.png`);
}

(async () => {
  await shoot(375, 2400, '375-iphone');
