    ...
    <main className="flex flex-1 flex-col">
      ...
      <section className="animate-slide-up relative pt-2 sm:pt-6">
        ...
        <p className="mt-5 flex flex-wrap items-center gap-x-3 gap-y-1 text-[12px] text-[#7A7F8A] sm:text-[13px]">
          <span><span className="font-semibold text-white">From $697/mo</span> · 2 plans, all done-for-you</span>
        ...
        <div className="mt-8 flex flex-col gap-3">
          {[
            ...
            },
            {
              ...
              a: 'Two simple monthly plans, no long-term contracts: Growth $697/mo (most popular), Pro $997/mo. Every plan is done-for-you with no feature gates — Pro adds a monthly strategy call and multi-market coverage. No setup fee.',
            },
            {
