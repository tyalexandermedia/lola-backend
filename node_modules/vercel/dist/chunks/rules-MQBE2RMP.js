...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-6PFY2I7Q.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-6PFY2I7Q.js")).default(client, args);
    case "add":
      return (await import("./add-6IFGG2TY.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-7AZGYZDI.js")).default(client, args);
    case "rm":
      return (await import("./rm-V7DGLIHX.js")).default(client, args);
    case "update":
      return (await import("./update-GSQ26HZG.js")).default(client, args);
    default:
