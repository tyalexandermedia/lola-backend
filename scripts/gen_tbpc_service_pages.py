...
.hero{position:relative;background:linear-gradient(100deg,rgba(8,24,36,.96) 0%,rgba(9,28,42,.88) 52%,rgba(10,31,46,.62) 100%),url("/images/tampa-bay-power-clean-hero.jpg") center right/cover no-repeat;border-bottom:6px solid var(--gold)}
...
<link rel="preload" as="image" href="/images/tampa-bay-power-clean-hero.jpg" fetchpriority="high">
