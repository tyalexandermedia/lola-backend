...
```json
{
  ...
  "@type": "Service",
  "serviceType": "Local SEO for Roofing Contractors",
  "provider": {
    "@type": "LocalBusiness",
...
### What we do (for Florida roofers)

1. **Hurricane-season GMB strategy** — pre-loaded posts, emergency service tags, FEMA-region targeting
2. **Insurance claim content** — "do I need a new roof after hurricane [X]," "how to file a roof claim"
3. **Storm chaser defense** — outrank out-of-state companies that flood Florida after storms
4. **AI Search Visibility** — track ChatGPT/Perplexity recommendations for "best roofer [city]"
5. **GAF/Owens Corning certification schema** — display credentials Google trusts
6. **Review velocity** — capture reviews mid-project, not just at completion
7. **Service-area pages** — one per city you serve, properly structured for local intent
...
- [Florida Department of Business Regulation — roofing licenses](https://www2.myfloridalicense.com/)
