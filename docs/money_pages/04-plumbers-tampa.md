...
```json
{
  ...
  "@type": "Service",
  "serviceType": "Local SEO for Plumbing Contractors",
  "provider": {
    "@type": "LocalBusiness",
...
### What we do (for Tampa plumbers)

1. **Emergency-keyword optimization** — "emergency plumber Tampa," "water heater repair Tampa," "drain cleaning near me"
2. **24/7 schema markup** — Google shows "Open 24 hours" in your snippet for after-hours searches
3. **GMB Map Pack** — service-area tuning for Tampa + Brandon + Riverview + Carrollwood
...
**1. Will this help me rank for "emergency plumber Tampa"?**
...
- [Google's mobile-first indexing docs](https://developers.google.com/search/mobile-sites/mobile-first-indexing)
